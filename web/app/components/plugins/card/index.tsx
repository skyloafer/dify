...
const Card = ({
  ...
  const cornerMark = isBundle
    ? categoriesMap.bundle?.label
    : categoriesMap[category]?.label;
            ...
            <div className="flex h-5 items-center">
              ...
              {isPartner && (
                <Partner
                  ...
                  text={t("plugin.marketplace.partnerTip")}
                />
              )}
              {verified && (
                <Verified
                  className="ml-0.5 h-4 w-4"
                  text={t("plugin.marketplace.verifiedTip")}
                />
              )}
