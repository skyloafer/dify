      ...
      <div className="flex h-full justify-center overflow-y-auto overflow-x-hidden">
        <div className="flex flex-1 shrink-0 justify-end">
          <div className="px-10">
            ...
            <div
              className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-[10px] bg-components-button-tertiary-bg hover:bg-components-button-tertiary-bg-hover"
              ...
              <div>
                <div className="mb-2 flex items-center">
                  ...
                  >
                    ...
                    <RiArrowRightSLine
                      className={`ml-1 h-4 w-4 text-text-tertiary transition-transform ${isAppTypeExpanded ? "rotate-90" : ""}`}
                    />
                  </button>
                </div>
                {isAppTypeExpanded && (
            ...
            <div className="flex items-center justify-between pb-10 pt-5">
              <div
                className="system-xs-regular flex cursor-pointer items-center gap-1 text-text-tertiary"
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  <div className="flex gap-0.5">
                    <RiCommandLine
                      size={14}
                      className="system-kbd rounded-sm bg-components-kbd-bg-white p-0.5"
                    />
                    <RiCornerDownLeftLine
                      size={14}
                      className="system-kbd rounded-sm bg-components-kbd-bg-white p-0.5"
        ...
        <div className="relative flex h-full flex-1 shrink justify-start overflow-hidden">
          ...
          <div className="max-w-[760px] border-x border-x-divider-subtle">
            <div className="h-6 2xl:h-[139px]" style={{ height: "57px" }} />
...
function AppTypeCard({
  ...
  return (
    <div
      className={cn(
        `relative box-content h-[84px] w-[191px] cursor-pointer rounded-xl
      border-[0.5px] border-components-option-card-option-border
      bg-components-panel-on-panel-item-bg p-3 shadow-xs hover:shadow-md`,
        active
          ? "shadow-md outline outline-[1.5px] outline-components-option-card-option-selected-border app_chose_card"
          : "",
      )}
      onClick={onClick}
    >
      {icon}
      <div className="system-sm-semibold mb-0.5 mt-2 text-text-secondary">
        {title}
      </div>
      <div
        className="system-xs-regular line-clamp-2 text-text-tertiary"
        title={description}
      >
        {description}
      </div>
      ...
      <div className="system-xs-regular mt-1 min-h-8 max-w-96 text-text-tertiary">
        ...
        {previewInfo.link && (
          <Link
            ...
            className="ml-1 text-text-accent"
          >
